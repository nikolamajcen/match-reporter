...
-- --------------------------------------------------
-- Date Created: 07/10/2015 18:54:54
-- Generated from EDMX file: D:\Programiranje\Visual Studio\Desktop\MatchReporter\MatchReporter\MatchReporterModel.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [MatchReporterDatabase];
GO
...
IF OBJECT_ID(N'[dbo].[FK_CityClub]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Clubs] DROP CONSTRAINT [FK_CityClub];
GO
...
IF OBJECT_ID(N'[dbo].[FK_ClubClubOfficial]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ClubOfficials] DROP CONSTRAINT [FK_ClubClubOfficial];
GO
...
GO
IF OBJECT_ID(N'[dbo].[ClubOfficials]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ClubOfficials];
GO
